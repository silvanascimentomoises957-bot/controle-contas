...
const AuthScreen = ({ onLogin }) => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: "linear-gradient(135deg, #f0f4ff 0%, #e8f4fd 100%)" }}>
      <div className="auth-left" style={{ flex: 1, display: "flex", background: `linear-gradient(135deg, ${C.brand} 0%, ${C.brandDark} 100%)`, alignItems: "center", justifyContent: "center", padding: 48, flexDirection: "column", gap: 24 }}>
        <Logo size={48} white />
